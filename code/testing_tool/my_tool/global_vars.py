...
API_Fields["long_running_recognize"] = [("transcript", "\"\""), ("confidence", -0.1), ("alternatives", True), ("results", "\"\"")] # alternativesfield actually are not boolean. This setting is for efficiency
