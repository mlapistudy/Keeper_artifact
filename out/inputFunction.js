...
function inputmultiStepInput(root, workspace, userInput, logging) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cmd = `cd ${root}; python3 type_output.py -f '${state.func_name}' -t '${state.input_types}' -d '${workspace}' -n '${state.func_def_line}' -cf '${state.code_file}' -p '${state.api_params}'`;
        ...
        cmd = `cd ${mainToolPath}; ${userInput} python3 -u all_wrap_up.py --input_json ${inputJson} --output_json ${outputJson} --log_file ${logsJson}`;
