...
if __name__ == '__main__':
  ...
  try:
    ...
    for i in range(len(generatedInputs)):
      ...
      command = "python3 "+ cov_test_filename +" --rss-limit-mb=20480 --timeout=60 --runs=1 --loc_file="+ cov_test_filename
        ...
        for generated_files in item.split('|\n|'):
          ...
          try:
            if len(generated_files.split('|\t|')) == 1:
              ...
              command = "python3 "+ test_file +" --rss-limit-mb=20480 --timeout=60 --runs=1 --loc_file="+ test_file
              if options.func_params:
                if item in all_inputs_list:
